---
title: 'Work in Progress: Case Study: Mobi Bikeshare in Vancouver'
author: "Andrew Luyt"
date: "07/07/2021"
...
- can you identify commutes, errands, and pleasure rides?
  - commutes are probably from one station to a different one, no stopovers
  - errands are probably from one station to the same station, with a stopover
  ...
  - do these categories form clear patterns in the data?
    - how could you verify these observations if they are there?
      - is there a usage survey that says how the mobi membership USES their bikes?
      - are there patterns visible on the map?
      - are there **time** or **place** (departure/arrival) patterns correlated with each usage group?
- bicycle attrition?
